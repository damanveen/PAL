...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="/PAL/javascript/ckeditor/ckeditor.js"></script>
		
		<script type="text/javascript" src="/PAL/javascript/jscolor/jscolor.js"></script>
			...
			<center>
				...
				<div class="content">
					...
					<p id="home">
						...
						<form action="/PAL/php/homepageContent.php" method="POST">
					...
					<div id="themer">	
						...
						<form action="/PAL/php/colorPicker.php" method = "POST">
						...
						<form action="/PAL/php/colorPicker.php">
