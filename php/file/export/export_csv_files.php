...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-students.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-student_info.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-courses.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-comments.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-year.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-class.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-student_progress.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-progress_report.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-level.csv","r+");
...
$file = fopen($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . "pal-student_comments.csv","r+");
...
$zip = new ZipArchive();
$zip->open($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'wcss_pal-tables.zip', ZipArchive::CREATE);

$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-students.csv', 'pal-students.csv');
//echo file_exists ("pal-students.csv");
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-student_info.csv', 'pal-student_info.csv');
//echo file_exists ("pal-student_info.csv");
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-courses.csv', 'pal-courses.csv');
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-comments.csv', 'pal-comments.csv');
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-year.csv', 'pal-year.csv');
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-class.csv', 'pal-class.csv');
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-student_progress.csv', 'pal-student_progress.csv');
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-progress_report.csv', 'pal-progress_report.csv');
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-level.csv', 'pal-level.csv');
$zip->addFile($_SERVER['DOCUMENT_ROOT'] . "/PAL/php/file/export/" . 'pal-student_comments.csv', 'pal-student_comments.csv');
